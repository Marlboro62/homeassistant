...
from .const import (
    ...
    TORQUE_GPS_LAT,
    TORQUE_GPS_LON,
    # on ajoute l'altitude
    TORQUE_GPS_ALTITUDE,
)

# URL d'image personnalis̩e : on essaye d'abord de l'importer depuis const.py,
...
class TorqueDeviceTracker(TorqueEntity, TrackerEntity, RestoreEntity):
    ...
    def __init__(self, coordinator: "TorqueLoggerCoordinator", config_entry: ConfigEntry, device: DeviceInfo):
        ...
        # Image personnalis̩e affich̩e comme vignette de l'entit̩
    ...
    def location_accuracy(self) -> Optional[int]:
        """Return the gps accuracy (meters)."""
        # Lire la donn̩e sur la voiture de l'entit̩
    ...
    def extra_state_attributes(self) -> Dict[str, Any] | None:
        """Expose altitude en attribut suppl̩mentaire."""
        attrs: Dict[str, Any] = {}
